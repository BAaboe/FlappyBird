...
pygame.display.set_icon(pipeUp)
...
def start_menu():
    f = open("C:/Users/21benmja01/Documents/python/FlappyBird/highscore.txt", "r")
    highscore = f.read()
    f.close()
...
def lost(poeng):
    ...
    if poeng > int(highscore):
        highscore = poeng
        f = open("C:/Users/21benmja01/Documents/python/FlappyBird/highscore.txt", "w")
